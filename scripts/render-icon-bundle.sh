#!/bin/bash
# Compile an Icon Composer .icon bundle with actool (exactly as Xcode does)
# and unpack the resulting icns so the rendering can be eyeballed without a
# full app build. Useful for checking layer order, glass, and small sizes.
#
